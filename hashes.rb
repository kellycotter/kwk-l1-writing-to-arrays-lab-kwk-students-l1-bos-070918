...
# student_celebrities << {"Natalie" => "Gigi Hadid", "Cece" => "Kendall Jenner", "Pelumi" => "Sam Smith", "Sidney" => "Charlie Puth", "Hope" => "Romme Strigid", "Christina" => "Billie"}

# puts student_celebrities["Celine"]
